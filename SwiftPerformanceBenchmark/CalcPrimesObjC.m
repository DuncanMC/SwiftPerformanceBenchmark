...
//-------------------------------------------------------------------------------------------------------
- (void) calcPrimesWithComputeRecordUsingNSArray: (ComputeRecord *) aComputeRecord
                              ...
                              andCompletionBlock: (calcPrimesCompletionBlock) theCalcPrimesCompletionBlock;
{
  ...
  NSMutableArray  *primes = [NSMutableArray arrayWithCapacity:aComputeRecord.totalToCalculate];
  ...
  while (prime_count < totalCount)
  {
    ...
    {
      int thisPrime = [primes[index] intValue];
      ...
      if (candidate % thisPrime == 0)
      {
        ...
        if (candidate  < thisPrime*thisPrime)
        {
          is_prime = true;
          break;
        }
...
- (void) calcPrimesWithComputeRecordUsingCArray: (ComputeRecord *) aComputeRecord
                          withUpdateDisplayBlock: (updateDisplayBlock) theUpdateDisplayBlock
                             andCompletionBlock: (calcPrimesCompletionBlock) theCalcPrimesCompletionBlock;
{
  //NSLog(@"Entering %s", __PRETTY_FUNCTION__);
...
- (void) calcPrimesWithComputeRecord: (ComputeRecord *) aComputeRecord
              withUpdateDisplayBlock: (updateDisplayBlock) theUpdateDisplayBlock
                  andCompletionBlock: (calcPrimesCompletionBlock) theCalcPrimesCompletionBlock;
{
  if (aComputeRecord.objC_useArrayObjects)
    [self calcPrimesWithComputeRecordUsingNSArray: aComputeRecord
                           withUpdateDisplayBlock: theUpdateDisplayBlock
                               andCompletionBlock: theCalcPrimesCompletionBlock];
  else
    [self calcPrimesWithComputeRecordUsingCArray: aComputeRecord
                           withUpdateDisplayBlock: theUpdateDisplayBlock
                               andCompletionBlock: theCalcPrimesCompletionBlock];
}
